...
class BrandController extends Controller
{
    ...
    public function BrandView(){
    	...
    	return view('dealer.template.brand.brand_view',compact('brands'));
    }

    /*=================== Start BrandAdd Methoed ===================*/
    public function BrandAdd(){
        return view('dealer.template.brand.brand_add');
    ...
    public function BrandStore(Request $request){
        ...
        $brand->created_by = Auth::guard('dealer')->user()->id;
        $brand->created_at = Carbon::now();

        $brand->save();

		Session::flash('success','Brand Inserted Successfully');
		return redirect()->route('dealer.brand.all');
    ...
    public function BrandEdit($id){
    	...
    	return view('dealer.template.brand.brand_edit',compact('brand'));
    }
    ...
    public function BrandUpdate(Request $request, $id){
        ...
        return redirect()->route('dealer.brand.all')->with($notification);
    } // end method
