...
class CategoryController extends Controller
{
    ...
    public function index(){
        ...
        return view('dealer.template.category.index',compact('categories'));
    } // end method
    ...
    public function create(){
        ...
        return view('dealer.template.category.create',compact('categories'));
    } // end method
    ...
    public function store(Request $request)
    {
        ...
        $category->created_by = Auth::guard('dealer')->user()->id;
        ...
        return redirect()->route('dealer.category.index');
    } // end method
    ...
    public function edit($id)
    {
        ...
        return view('dealer.template.category.edit',compact('category', 'categories'));
    } // end method
    ...
    public function CategoryUpdate(Request $request, $id){
		...
		return redirect()->route('dealer.category.all');
    }
