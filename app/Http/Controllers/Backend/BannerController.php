...
class BannerController extends Controller
{
    ...
    {
        if (Auth::guard('admin')->user()->role == '1' || in_array('81', json_decode(Auth::guard('admin')->user()->staff->role->permissions))) {
    ...
    {
        if (Auth::guard('admin')->user()->role == '1' || in_array('86', json_decode(Auth::guard('admin')->user()->staff->role->permissions))) {
    ...
    {
        if (Auth::guard('admin')->user()->role == '1' || in_array('83', json_decode(Auth::guard('admin')->user()->staff->role->permissions))) {
    ...
    {
        if (Auth::guard('admin')->user()->role == '1' || in_array('84', json_decode(Auth::guard('admin')->user()->staff->role->permissions))) {
