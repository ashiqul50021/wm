...
class AccountsController extends Controller
{
    ...
    {
        if (Auth::guard('admin')->user()->role == '1' || in_array('92', json_decode(Auth::guard('admin')->user()->staff->role->permissions))) {
    ...
    {
        if (Auth::guard('admin')->user()->role == '1' || in_array('93', json_decode(Auth::guard('admin')->user()->staff->role->permissions))) {
