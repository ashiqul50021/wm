...
class SellerCategoryController extends Controller
{
     ...
     public function index()
     {
         ...
         $categories = DB::table('categories as c')
             ...
             ->get();
         if ($role == "9") {
             return view('seller.template.category.index', compact('categories'));
         }

     } // end method

     /*=================== Start CategoryView Method ===================*/
     public function create()
     {
         ...
         return view('seller.template.category.create', compact('categories'));
         }
     } // end method
     ...
     public function store(Request $request)
     {
         ...
         $category->seller_id = Auth::guard('seller')->user()->id;
     ...
     public function edit($id)
     {
         ...
         return view('seller.template.category.edit', compact('category', 'categories'));
         }
     } // end method
     ...
     public function CategoryUpdate(Request $request, $id)
     {
         ...
         return redirect()->route('seller.category.all');
     }
