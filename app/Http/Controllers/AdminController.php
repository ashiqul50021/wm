...
class AdminController extends Controller
{
    ...
    public function Dashboard()
    {
        ...
        $priceValueOfProducts = Product::where('vendor_id', null)->orWhere('vendor_id', 0)->sum(DB::raw('purchase_price * stock_qty'));
        ...
        return view('admin.index', compact('userCount', 'productCount', 'categoryCount', 'brandCount', 'vendorCount', 'orderCount', 'lowStockCount', 'adminProducts','priceValueOfProducts'));
    } // end method
    ...
    public function Login(Request $request)
    {
        ...
        if (Auth::guard('admin')->attempt(['email' => $check['email'], 'password' => $check['password']])) {
            ...
            if (Auth::guard('admin')->user()->role == "1" || Auth::guard('admin')->user()->role == "5" && Auth::guard('admin')->user()->vendor_id == null) {
