...
Route::get('/check-timezone', function () {
    ...
    return "The current time zone is: $timezone";
});
...
/* ===============  Seller Wise Product Show  ============= */
Route::get('/seller-product/{slug}', [FrontendController::class, 'sellerWiseProduct'])->name('seller.product');
...
Route::get('/product/view/modal/{id}', [FrontendController::class, 'ProductViewAjax'])->name('ProductViewAjax');
Route::get('/product/view/modalNew/{id}', [FrontendController::class, 'ProductViewModal'])->name('ProductViewModal');
...
/*
|--------------------------------------------------------------------------
| PRODUCT REVIEWS ROUTE FOR USER
|--------------------------------------------------------------------------
*/
Route::post('/product-review-store', [ProductReviewController::class, 'productReviewStore'])->name('productReviewStore');
...
Route::post('/seller-apply', [FrontendController::class, 'sellerApply'])->name('sellerApply');
