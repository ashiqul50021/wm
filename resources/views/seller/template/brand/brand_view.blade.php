...
<section class="content-main">
    <div class="content-header">
        ...
        {{-- <div>
            <a href="{{ route('seller.brand.add') }}" class="btn btn-primary"><i class="material-icons md-plus"></i>Brand Create</a>
        </div> --}}
    </div>
    </div>
    <div class="card mb-4">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <td class="text-end">
                                    ...
                                    @if($brand->seller_id == Auth::guard('seller')->user()->id && $brand->seller_id != NULL)
                                    <div class="dropdown">
                                        <a href="#" data-bs-toggle="dropdown" class="btn btn-light rounded btn-sm font-sm"> <i class="material-icons md-more_horiz"></i> </a>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('seller.brand.edit',$brand->id) }}">Edit info</a>
                                            <a class="dropdown-item text-danger" href="{{ route('seller.brand.delete',$brand->id) }}" id="delete">Delete</a>
                                        </div>
                                    </div>
                                    @endif
                                    <!-- dropdown //end -->
