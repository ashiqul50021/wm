...
<section class="content-main">
    <div class="content-header">
        ...
        <div class="">
            <a href="{{ route('seller.product.all') }}" class="btn btn-primary"><i class="material-icons md-plus"></i> Product List</a>
        </div>
    </div>
	<div class="row">
		{{-- @if ($errors->any())
                        ...
                        <div class="row">
                            ...
                            <div class="row" id="single_price">
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <input class="form-control" id="regular_price" type="number" step="any"
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <input class="form-control" id="discount_price" type="number" step="any"
...
<script type="text/javascript">
    function productRemove(id){
        ...
        $.ajax({
           type:'GET',
           url:"/seller/product/multiimg/delete/"+id,
           dataType: 'json',
           success:function(data){
             location.reload();
           	//console.log(data);
