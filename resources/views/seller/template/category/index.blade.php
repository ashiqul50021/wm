...
<section class="content-main">
    <div class="content-header">
        ...
        {{-- <div>
            <a href="{{ route('seller.category.create') }}" class="btn btn-primary"><i class="material-icons md-plus"></i> Add Category</a>
        </div> --}}
    </div>
    </div>
    <div class="card mb-4">
                ...
                <table id="example" class="table table-bordered table-striped" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                {{-- @dd($category->seller_id) --}}
                                @if($category->seller_id == Auth::guard('seller')->user()->id && $category->seller_id != NULL)

                                <a class="btn btn-md rounded font-sm" href="{{ route('seller.category.edit',$category->id) }}">Edit</a>
                                <a class="btn btn-md rounded font-sm bg-danger" href="{{ route('seller.category.delete',$category->id) }}" id="delete">Delete</a>
                                @endif
                            </td>
                            @endif
                        </tr>
