...
<section class="content-main">
    <div class="content-header">
        ...
        <div class="">
            <a href="{{route('vendor.staff.index') }}" class="btn btn-primary"><i class="material-icons md-plus"></i> Staff List</a>
        </div>
    </div>
    	...
    	<div class="col-sm-6">
    		<div class="card">
		        <div class="card-body">
		            <div class="row">
		                <div class="col-md-12">
		                    <form action="{{ route('vendor.staff.update', $staff->id) }}" method="POST" enctype="multipart/form-data">
		                    	@csrf
		                        <div class="">
		                        ...
		                        <div class="custom_select mb-4">
                                    ...
                                    <select class="form-control select-active w-100 form-select select-nice" name="role_id" id="role_id">
					                	...
					                	@foreach($roles as $role)
					                		<option value="{{ $role->id }}" @php if($staff->vendor_role_id == $role->id) echo "selected"; @endphp>{{ $role->name }}</option>
					               		@endforeach
                                    </select>
                                </div>
