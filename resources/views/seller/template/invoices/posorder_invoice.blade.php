...
@php
 use App\Models\Vendor;
    ...
    $vendorData = Vendor::where('user_id', $id)
        ->with('user')
        ->first();
@endphp
    @push('css')
                ...
                <div class="mb-5 mt-3">
                    <div class="invoice_top mb-5">
                        <div class="row justify-content-between">
                            <div class="col-sm-6">
                                ...
                                <p style="font-size: x-large; font-weight: 600;color: black;padding: 10px">{{$vendorData->shop_name ?? 'N/A'}}</p>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="row my-5 mx-1 justify-content-center table-responsive">
                        <table class="table table-striped table-borderless">
                            ...
                            <tbody>
                                @foreach ($posOrder->vendorPosOrderItem as $key=> $item )
                                <tr>
                    ...
                    <div class="row gy3">
                        ...
                        <div class="col-md-6">
                            <div class="invoice_payment ms-md-auto">
                                <ul class="list-unstyled text-md-end">
                                    <li class="">
                                        <strong class="me-4">SubTotal</strong> <span>{{$posOrder->subtotal ?? 'N/A'}}</span>
                                    </li>
                                    <li class="">
                                        <strong class="me-4">discount</strong> <span>{{$posOrder->discount ?? 'N/A'}}</span>
                                    </li>
                                    <li class="">
                                        <strong class="me-4">Total</strong> <span>{{$posOrder->total ?? 'N/A'}}</span>
                                    </li>
                                    <li class="">
                    ...
                    <div class="text-center btn_text" id="btn_wrapper">
                        <a class="btn btn-light text-capitalize border-0" id="print" target="_blank"
                            href="{{ route('vendor.pos.orderPrint', $posOrder->id) }}" data-mdb-ripple-color="dark"><i
                                class="fas fa-print text-primary"></i> Print</a>
                        <a href="{{ route('vendor.pos.index') }}" class="btn btn-light text-capitalize"
