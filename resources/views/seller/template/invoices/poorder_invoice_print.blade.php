                    ...
                    <section class="header__section">
                        <div class="header__logo">
                            ...
                            <img style="font-size: 1.8rem; display: flex;  margin: 0 auto;"
                                ...
                                alt="{{ env('APP_NAME') }}">
                                <p style="font-size:15px; font-weight: 600">{{$vendorData->shop_name ?? 'N/A'}}</p>
                        @else
                            <img src="{{ asset('upload/no_image.jpg') }}" alt="{{ env('APP_NAME') }}">
                            <p>{{$vendorData->shop_name ?? 'N/A'}}</p>
                        @endif
                        </div>
                        <div class="header__content">
                            <h2>Wood Machinery and <br> Hardware</h2>
                            <p>{{$vendorData->address ?? 'Address not found'}}<br>
                                Phone Number{{$vendorData->user->phone ?? 'Phone Not Found'}}</p>
                            <span>Email: {{$vendorData->user->email ?? 'Email not found'}}</span>
                        </div>
                        <div></div>
                    </section>
                </header>
                        ...
                        <div class="product__payment__info">
                            ...
                            <ul class="amount__info">
                                ...
                                <li style="border-bottom: 1px solid #000;margin-top: 5px;">
                                    ...
                                    <span>(-){{ $posOrder->discount ?? 'N/A' }}</span>
                                </li>
                                <li>
