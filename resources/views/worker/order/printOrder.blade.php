            ...
            @if ($order != null)
                <table style="padding: 20px 0px;">
                    <tr>
                        ...
                        <td style="text-align: center"><span style="font-weight: 800; margin-left:5px;"> Name
                                :</span> {{ $order->user->name ?? '' }}</td>
                    </tr>
                    <tr>
                        {{-- @dd($product->user->name) --}}
                        <td style="text-align: center"><span style="font-weight: 800; margin-left:5px;">Customer Name
                                :</span> {{ $order->customer_name ?? '' }}</td>
                    </tr>
                    <tr>
                        <td style="text-align: center"><span style="font-weight: 800; margin-left:5px;">Product Name: </span>
...
<hr>
        <div class="d-flex justify-content-around">
            <div style="font-size: 13px; margin: 20px 10px; padding-bottom: 5px;"><p> Note: {{$order->message ?? ''}}</p></div>
