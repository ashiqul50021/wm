                    ...
                    <div class="product__info__table">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="padding: 0;margin: 0; text-align: center; width: 60%">Product Name</th>
                        ...
                        <div class="product__payment__info">
                            ...
                            <li>
                                ...
                                <li class="mt-5"><span style="font-weight: bold">Description:</span>
                                    {{ $dealerConfirm->note ?? 'N/A' }}</li>
                            </ul>
