...
<section class="content-main">
    <div class="content-header">
        ...
        <div class="">
            <a href="{{ route('dealer.brand.all') }}" class="btn btn-primary"><i class="material-icons md-plus"></i> Brand List</a>
        </div>
    </div> 
        ...
        <div class="col-sm-8">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form method="post" action="{{ route('dealer.brand.update',$brand->id) }}" enctype="multipart/form-data">
                                @csrf
