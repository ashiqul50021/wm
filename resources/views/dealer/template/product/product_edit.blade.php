...
<section class="content-main">
	...
	<div class="row">
        <div class="col-md-10 mx-auto">
			<form method="post" action="{{ route('dealer.product.update',$product->id) }}" enctype="multipart/form-data">
				@csrf
				...
				<div class="card">
		        	...
		        	<div class="card-body">
		        		...
		        		<div class="row">
		        			...
		        			<input type="hidden" name="vendor_id" id="vendor_id" value="{{ Auth::guard('dealer')->user()->id }}" />
...
<script type="text/javascript">
	$(document).ready(function (e) {
			...
			$.ajax({
				type:'POST',
				url: "{{ route('dealer.category.ajax.store') }}",
				data: formData,
				cache:false,
				contentType: false,
				processData: false,
...
<script type="text/javascript">
	$(document).ready(function (e) {
			...
			$.ajax({
				type:'POST',
				url: "{{ route('dealer.brand.ajax.store') }}",
				data: formData,
				cache:false,
				contentType: false,
				processData: false,
...
<script type="text/javascript">
    function productRemove(id){
        ...
        $.ajax({
           type:'GET',
           url:"/dealer/product/multiimg/delete/"+id,
           dataType: 'json',
           success:function(data){
             location.reload();
           	//console.log(data);
