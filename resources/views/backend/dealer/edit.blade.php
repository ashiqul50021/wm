					...
					<form method="post" action="{{ route('dealer.update',$dealer->id) }}" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-6 mb-4">
								...
								<input class="form-control" id="shop_name" type="text" name="shop_name" placeholder="Write Dealer Shop name" value="{{ $dealer->shop_name ?? '' }}">
								@error('shop_name')
									<p class="text-danger">{{$message}}</p>
								@enderror
							</div>
							...
							<div class="col-md-6 mb-4">
								...
								<input class="form-control" id="google_map_url" type="text" name="google_map_url" placeholder="Write Google Map Url" value="{{ $dealer->google_map_url ?? '' }}">
						...
						<div class="row">
                            ...
                            <div class="col-md-6">
								<div class="mb-4">
									 <label for="image5" class="col-form-label" style="font-weight: bold;">Shop Image: <span class="text-danger">*</span></label>
									<input name="shop_image" class="form-control" type="file" id="image5">
								</div>
								<div class="mb-4">
									 <img id="showImage5" class="rounded avatar-lg" src="{{ (!empty($dealer->shop_image))? url($dealer->shop_image):url('upload/no_image.jpg') }}" alt="Card image cap" width="100px" height="80px;">
								</div>
							</div>
