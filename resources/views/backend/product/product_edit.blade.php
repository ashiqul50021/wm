                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input class="form-control" id="unit_weight" type="number" name="unit_weight"
                                        placeholder="Write unit weight" value="{{ $product->unit_weight }}" step="any">
                                </div>
                                <div class="col-md-6 mb-4">
                                ...
                                <div class="row" id="single_price">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <input class="form-control" id="purchase_price" type="number"
                                            ...
                                            value="{{ $product->purchase_price }}" step="any">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input class="form-control wholeSellDiscount" id="wholesell_discount" type="number"
                                            name="wholesell_discount" placeholder="Write product whole sell price"
                                            value="{{ $product->whole_sell_dis ?? '' }}" step="any">
                                    </div>
                                    <div class="col-md-4 mb-4">
                                        <label for="whole_sell_dis_type" class="col-form-label"
                                            style="font-weight: bold;">Wholesell Discount Type:</label>
                                        <div class="custom_select">
                                            <select class="form-control select-active w-100 form-select select-nice wholesellDiscountType"
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input class="form-control vwholesaleprices" id="wholesell_price" type="number"
                                            ...
                                            value="{{ $product->wholesell_price }}" step="any">
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input class="form-control" id="wholesell_minimum_qty" type="number"
                                            ...
                                            value="{{ $product->wholesell_minimum_qty }}" step="any">
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <input class="form-control regularPrice" id="regular_price" type="number"
                                            ...
                                            value="{{ $product->regular_price }}" min="0" step="any">
                                        @error('regular_price')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <input class="form-control" id="discount_price" type="number"
                                            ...
                                            placeholder="Write product discount price" step="any">
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <input class="form-control" id="minimum_buy_qty" type="number"
                                            ...
                                            value="{{ $product->minimum_buy_qty }}" min="1" step="any">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input class="form-control" id="stock_qty" type="number" name="stock_qty"
                                            ...
                                            placeholder="Write product stock qty" step="any">
                                        @error('stock_qty')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input class="form-control" id="body_rate" type="number" name="body_rate"
                                            ...
                                            placeholder="Write Body Rate" step="any">
                                        @error('body_rate')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input class="form-control" id="finishing_rate" type="number" name="finishing_rate"
                                            value="{{ $product->finishing_rate }}" min="0"
                                            placeholder="Write Finishing" step="any">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input class="form-control" id="model_number" type="text" name="model_number"
