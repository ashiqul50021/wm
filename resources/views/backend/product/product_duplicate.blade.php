    ...
    <section class="content-main">
		...
		@endif --}}
            <div class="col-md-12 mx-auto">
                <form method="post"
                    action="@if ($product->is_varient) {{ route('product.duplicate.store') }} @else
                    {{ route('product.store') }} @endif"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                        ...
                                        <select class="form-control select-active w-100 form-select select-nice"
                                            ...
                                            @foreach ($categories as $category)
                                                ...
                                                @foreach ($category->childrenCategories as $childCategory)
                                                    <option value="{{ $childCategory->id }}"> {!! str_repeat('-', $loop->depth) !!}
                                                        {{ $childCategory->name_en }}</option>
                                                @endforeach
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    {{-- <label for="variant_name" class="col-form-label" style="font-weight: bold;">Varient Name</label> --}}
                                    <input class="form-control" id="unit_weight" type="hidden" name="variant_name"
                                        placeholder="Write unit weight" value="{{ $product->variant_name }}">
                                </div>
                            </div>
                            <!-- row //-->
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row" id="single_price">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <label for="purchase_code" class="col-form-label"
                                            style="font-weight: bold;">Purchase Code:</label>
                                        <input class="form-control" id="purchase_code" type="text"
                                            name="purchase_code" placeholder="Write Purchase Code"
                                            value="{{ $product->purchase_code ?? '' }}">
                                        @error('purchase_code')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input class="form-control wholeSellDiscount" id="wholesell_discount"
                                            ...
                                            placeholder="Write product whole sell price"
                                    ...
                                    @if ($product->is_varient)
                                        <div class="col-md-6 mb-4">
                                            <label for="body_rate" class="col-form-label" style="font-weight: bold;">Body
                                                Rate:</label>
                                            <input class="form-control" id="body_rate" type="number" name="body_rate"
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="finishing_rate" class="col-form-label"
                                                style="font-weight: bold;">Finishing Rate:</label>
                                            <input class="form-control" id="finishing_rate" type="number"
                                                name="finishing_rate" value="{{ $product->finishing_rate }}"
                                                min="0" placeholder="Write Finishing">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="model_number" class="col-form-label"
                                                style="font-weight: bold;">Model No:</label>
                                ...
                                @if ($product->is_varient)
                                    <input type="hidden" name="is_variant" value="{{ $product->is_varient }}">
                                @endif
                                {{-- @else --}}
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if ($product->is_varient)
                                <div class="mb-4">
                                    <label for="menu_facture_image" class="col-form-label"
                                        style="font-weight: bold;">Menufacture Image:</label>
                                    <input type="file" name="menu_facture_image" class="form-control"
                                ...
                                <div class="row">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="form-check-input me-2 cursor" name="is_dealer"
                                            id="is_dealer" {{ $product->is_dealer == 1 ? 'checked' : '' }}
                                            value="1">
...
@push('footer-script')
                    ...
                    if (Object.keys(response.data).length > 0) {
                        ...
                        $('#combination_table tbody').html($.map(response.data, function(item, index) {
                            return `<tr>
									...
									<td><input type="text" name="vpurchesprices[]" class="form-control vdpurchase_price" value="` +
                                purchase_price + `" required></td>
									...
									<td><input type="text" name="vwhole_sell_prices[]" class="form-control vdwhole_sell_price" value="` +
                                whole_sell_price + `" required></td>
									<td><input type="text" name="vwhole_sell_qtys[]" class="form-control vdwhole_sell_qty" value="` +
    ...
    <script type="text/javascript">
        ...
        function menuThamUrl(input) {
            if (input.files && input.files[0]) {
                var reader = new FileReader();
                reader.onload = function(e) {
                    $('#menuThmb').attr('src', e.target.result).width(100).height(80);
                };
                reader.readAsDataURL(input.files[0]);
            }
        }
    ...
    <script>
        ...
        function calculation() {
            ...
            $('.vwholesaleprices').val(totalPrice);
