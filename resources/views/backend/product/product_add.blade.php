...
@section('admin')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                @if (get_setting('multi_vendor')->value)
                                    ...
                                    @else
                                        <div class="col-md-6 mb-4">
                                            <label for="vendor_id" class="col-form-label" style="font-weight: bold;">Vendor:
                                               </label>
                                            <div class="custom_select">
                                                <select class="form-control select-active w-100 form-select select-nice"
                                                    ...
                                                    @foreach ($vendors as $vendor)
                                                        <option value="{{ $vendor->user_id }}">{{ $vendor->shop_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                @error('vendor_id')
                            ...
                            <div class="row">
                                <div class="row" id="single_price">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <label for="regular_price" class="col-form-label"
                                            style="font-weight: bold;">Regular Price: <span
                                                class="text-danger">*</span></label>
                                        <input class="form-control regularPrice" id="regular_price" type="number"
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input class="form-control wholeSellDiscount" id="wholesell_discount"
                                            type="number" name="wholesell_discount"
                                            placeholder="Write product whole sell price" value="0">
                                    </div>
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="custom_select">
                                            <select
                                                class="form-control select-active w-100 form-select select-nice wholesellDiscountType"
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input class="form-control vwholesaleprices" id="wholesell_price" type="number"
                                ...
                                <div class="col-12 mt-2 mb-2" id="variation_wrapper"
                                    ...
                                    <div class="prodcuct_add_column_wrapper">
                                        <div id="combination_table">
                                            <div class="row gy-3 combination_table_main">
    ...
    @push('footer-script')
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (Object.keys(response.data).length > 0) {
                            ...
                            $('#combination_table .combination_table_main').html($.map(response.data, function(item,
                                index) {
                                return `
                                ...
                                <div class="col-md-6">
                                   <div>
                                    <label>Variant</label>
                                    ${index}<input type="hidden" name="vnames[]" class="form-control" value="${index}" required>
                                </div>
                                <div>
                                    <label>Model No</label>
                                    <input type="text" name="vskus[]" class="form-control" required value="model-${index}">
                                </div>


                                <div>
                                    <label>Regular Price</label>
                                    <input type="text" name="vprices[]" class="form-control regularPriceDouble" data-id="${index}" value="` +
                                    price +
                                    `" required>
                                </div>
                                <div>
                                    <label>Regular Discount</label>
                                    <input type="text" name="vdis_prices[]" class="form-control">
                                </div>
                                <div>
                                    <label>Wholesale Discount</label>
                                    <input type="text"  name="vwholesalediscount[]" class="form-control wholeSellDiscountDouble" data-id="${index}" required>
                                </div>

                                <div>
                                    <label>Wholesale Price</label>
                                    <input type="text" name="vwholesaleprices[]" class="form-control vwholesalepricesDouble" data-id="${index}" readonly value="` +
                                    whole_sell_price +
                                    `" required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="vqtys[]" class="form-control" value="` + qty +
                                    `" required>
                                </div>

                                <div>
                                    <label>Manufacturing Image</label>
                                    <input type="file" name="vmanufimages[]" class="form-control">
                                </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="vpurchesprices[]" class="form-control vdpurvhedp" value="` +
                                    purchase_price +
                                    `" required>
                                </div>
                                ...
                                <div class= "col-md-6">
                                    ...
                                    <input type="text" name="vpurchescodes[]" class="form-control vdpurvhedp" value="` +
                                    purchase_code +
                                    `">
                                </div>

                                    <div>
                                    <label>Regular Discount type</label>
                                ...
                                <div>
                                    <label>Wholesale Discount Type</label>
                                    <select class="form-control select-active w-100 form-select select-nice wholesellDiscountTypeDouble" data-id="${index}" name="vwhole_dis_type[]" id="discount_type">
    				                	<option value="1">Flat</option>
                                		<option value="2">Parcent %</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="vwholesaleqtys[]" class="form-control vwholesaleqtys" value="` +
                                ...
                                <div>
                                    <label>Photo</label>
                                    <input type="file" name="vimages[]" class="form-control">
                                </div>

                                <div>
                                    <label>Body Rate</label>
                                    <input type="text" name="vbodyrates[]" class="form-control">
                                </div>

                                <div>
                                    <label>Finishing Rate</label>
                                    <input type="text" name="vfinishingrates[]" class="form-control">
                                </div>
                            ...
                            $('#combination_table .combination_table_main').html();
                        }
                    }
                });
            }
        ...
        <!--discount type-->
        <script>
            $(document).on("keyup", ".wholeSellDiscountDouble", function() {
                var index = $(this).attr('data-id')


                var wholesalediscountValue = parseFloat($(this).val()) || 0;
                console.log(wholesalediscountValue)
                var regularPrice = parseFloat($('.regularPriceDouble[data-id="' + index + '"]').val()) || 0;
                console.log(index, regularPrice)
                calculation(index)



            })
            $(document).on("change", ".wholeSellDiscountDouble", function() {
                var index = $(this).attr('data-id')
            ...
            $(document).on("change", ".wholesellDiscountTypeDouble", function() {
                var index = $(this).attr('data-id')
                calculation(index)
            })
            $(document).on("change", ".regularPriceDouble", function() {
                var index = $(this).attr('data-id')
                calculation(index)
            })
            $(document).on("keyup", ".regularPriceDouble", function() {
                var index = $(this).attr('data-id')
                calculation(index)
            })
            ...
            function calculation(index) {
                var discountType = $('.wholesellDiscountTypeDouble[data-id="' + index + '"]').val();
                var regularPrice = parseFloat($('.regularPriceDouble[data-id="' + index + '"]').val()) || 0;
                var wholesalediscountValue = parseFloat($('.wholeSellDiscountDouble[data-id="' + index + '"]').val()) || 0;
                var totalPrice = 0;
                var discountAmount = 0;
                if (discountType == 1) {
                    discountAmount = wholesalediscountValue;
                    totalPrice = regularPrice - discountAmount;
                } else {
                    discountAmount = regularPrice * wholesalediscountValue / 100;
                    totalPrice = regularPrice - discountAmount;
                }
                $('.vwholesalepricesDouble[data-id="' + index + '"]').val(totalPrice);

                console.log('discount amount', discountAmount)
                console.log('after disocunt total price', totalPrice)
            }
        </script>



        <!--single product wholesell discount--->
        <script>
            $(document).on("keyup", ".wholeSellDiscount", function() {
            ...
            $(document).on("change", ".wholeSellDiscount", function() {
            ...
            $(document).on("change", ".wholesellDiscountType", function() {
                calculationSingle()
            })
            ...
            function calculationSingle() {
                var discountType = $('.wholesellDiscountType').val();
                var regularPrice = parseFloat($('.regularPrice').val()) || 0;
                var wholesalediscountValue = parseFloat($('.wholeSellDiscount').val()) || 0;
                var totalPrice = 0;
                var discountAmount = 0;
                if (discountType == 1) {
                    discountAmount = wholesalediscountValue;
                ...
                $('.vwholesaleprices').val(totalPrice.toFixed());
