                            ...
                            <tbody>
                                ...
                                @foreach ($order->order_details as $key => $orderDetail)
                                    <tr>
                                        ...
                                        <td>{{ $orderDetail->product->user->name ?? 'Admin' }}</td>
...
<script>
    $(document).ready(function () {
        ...
        // Event listener for delivery status change
        $('#update_delivery_status').change(function () {
            var newDeliveryStatus = $(this).val();
            updateStatus(newDeliveryStatus);
        });
    });
</script>
