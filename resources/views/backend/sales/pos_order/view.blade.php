                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="" class="form-control" name="discount" readonly
                                                    value="{{ $posorder->overall_discount ?? '' }}"></td>
                                        </tr>
                                        <tr>
                                            <th>Date</th>
                                    ...
                                    <table id="example" class="table table-bordered table-striped" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="10%">OverAll Discount</th>
                                        ...
                                        <tbody>
{{-- @dd($posorder->posOrderItem) --}}
                                            @foreach ($posorder->posOrderItem as $key => $orderDetail)
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>{{ $posorder->overall_discount ?? '0' }}</td>
                                                    <td class="text-end">{{ $posorder->total ?? '0.00' }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                            <tr>
