...
<section class="content-main">
    <div class="content-header">
        <h2 class="content-title">Sellers Edit</h2>
        <div class="">
            <a href="{{ route('seller.index') }}" class="btn btn-primary"><i class="material-icons md-plus"></i> Seller List</a>
        </div>
    </div>
		                    ...
		                    <form method="POST" action="{{ route('seller.update',$seller->id) }}" enctype="multipart/form-data">
		                        ...
		                        <div class="mb-4">
		                          <label for="shop_name" class="col-form-label col-md-4" style="font-weight: bold;"> Shop Name : <span class="text-danger">*</span></label>
		                            <input class="form-control" id="shop_name" type="text" name="shop_name" placeholder="Write Seller shop name" value="{{$seller->shop_name}}">
									@error('shop_name')
								...
								<div class="mb-4">
		                          <label for="phone" class="col-form-label col-md-4" style="font-weight: bold;"> Phone : <span class="text-danger">*</span></label>
		                            <input class="form-control" id="phone" type="text" name="phone" placeholder="Write Seller phone number" value="{{$seller->user->phone}}">
									@error('phone')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
		                        </div>
								...
								<div class="mb-4">
		                          <label for="email" class="col-form-label col-md-4" style="font-weight: bold;"> Email : <span class="text-danger">*</span></label>
		                            <input class="form-control" id="email" type="email" name="email" placeholder="Write Seller email address" value="{{$seller->user->email}}">
									@error('email')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
		                        </div>
		                        ...
		                        <div class="mb-4">
		                          <label for="address" class="col-form-label col-md-4" style="font-weight: bold;">Address : <span class="text-danger">*</span></label>
		                            <input class="form-control" id="address" type="text" name="address" placeholder="Write Seller address" value="{{$seller->address}}">
									@error('address')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
		                        </div>
		                        <div class="mb-4">
		                          <label for="google_map_url" class="col-form-label col-md-4" style="font-weight: bold;">Google Map Url : <span class="text-danger"></span></label>
		                            <input class="form-control" id="google_map_url" type="url" name="google_map_url" placeholder="Write Google Map Url" value="{{$seller->google_map_url}}">
		                        ...
		                        <div class="mb-4">
		                          <label for="commission" class="col-form-label col-md-4" style="font-weight: bold;">Commission (Optional):</label>
		                            <input class="form-control" id="commission" type="text" name="commission" placeholder="Write Seller commission" value="{{$seller->commission}}">
		                        </div>

		                        <div class="mb-4">
		                          <label for="description" class="col-form-label col-md-4" style="font-weight: bold;">Description :</label>
		                            <textarea name="description" id="description" cols="5" placeholder="Write Seller description" class="form-control ">{{$seller->description}}</textarea>
		                        </div>
		                        ...
		                        <div class="row">
		                        	<div class="col-md-6">
				                        ...
				                        <div class="mb-4">
				                         	<img id="showImage" class="rounded avatar-lg" src="{{asset($seller->shop_profile) }}" alt="Card image cap" width="100px" height="80px;">
				                        </div>
				                    </div>
				                    ...
				                    <div class="col-md-6">
				                        ...
				                        <div class="mb-4">
				                         	<img id="showImage2" class="rounded avatar-lg" src="{{asset($seller->shop_cover) }}" alt="Card image cap" width="100px" height="80px;">
				                        </div>
				                    </div>
		                        </div>
		                       ...
		                       <div class="row">
		                       		<div class="col-md-6">
				                         ...
				                         <div class="mb-4">
				                         	<img id="showImage3" class="rounded avatar-lg" src="{{asset($seller->nid) }}" alt="Card image cap" width="100px" height="80px;">
				                        </div>
		                       		</div>
		                       		...
		                       		<div class="col-md-6">
				                         ...
				                         <div class="mb-4">
				                         	<img id="showImage4" class="rounded avatar-lg" src="{{asset($seller->trade_license) }}" alt="Card image cap" width="100px" height="80px;">
				                        </div>
		                       		</div>
		                       </div>
		                        ...
		                        <div class="mb-4">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="form-check-input me-2 cursor" name="status" id="status" value="1" {{ $seller->status == 1 ? 'checked': '' }} >
