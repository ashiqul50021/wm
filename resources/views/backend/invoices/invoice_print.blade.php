			...
			<table class="padding text-left small border-bottom">
				<thead>
	                <tr class="gry-color" style="background: #eceff4;">
	                    ...
	                    <th width="15%" class="text-left" style="font-weight: 600;">Discount Price</th>
	                </tr>
				</thead>
				<tbody class="strong">
	                @foreach ($order->order_details as $key => $orderDetail)
		                @if ($orderDetail->product != null)
							<tr class="">
								...
								<td class="currency">{{ $orderDetail->discount_1 }}</td>
							</tr>
		                @endif
					@endforeach
	            </tbody>
			            ...
			            <td>
					        <table class="text-right small strong">
						        <tbody>
									...
									@if($order->discount>0)
										<tr>
											<th class="gry-color text-left">Over All Discount </th>
