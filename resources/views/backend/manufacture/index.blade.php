...
@section('admin')
    ...
    <section class="content-main">
        <div class="content-header">
            <h2 class="content-title">Manufacture Order List <span class="badge rounded-pill alert-success">
                    @if (!empty($orders))
                        {{ count($orders) }}
                    @endif
                </span></h2>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('date.worker.search') }}" method="get" class="mb-3">
                    <div class="row">
                        <div class="col-md-3">
