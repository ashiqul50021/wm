                            ...
                            @if ($manufactureLedger->count() > 0)
                                @foreach ($manufactureLedger as $key => $item)
                                    <tr>
                                        ...
                                        <td> {{ $item->credit ?? '' }} </td>
                                        <td> {{ $item->total ?? '' }} </td>
                                        <td><a href="{{route('manufacture.PrintPaymentInfo',$item->id)}}" target="_blank" class="btn btn-primary w-2">Print</a></td>
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    @if (Auth::guard('admin')->user()->role == '2')
                                                        <a class="dropdown-item text-danger"
                                                            href="{{ route('manufacture.deletePaymentInfo', $item->id) }}"
                                                            id="delete">Delete</a>
                                                    @else
