...
@endphp
    <section class="content-main">
        <div class="content-header">
            <h2 class="content-title">Manufacture Pending Orders <span class="badge rounded-pill alert-success">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('pendingDateSearch') }}" method="get" class="mb-3">
                    <div class="row">
                        <div class="col-md-3">
