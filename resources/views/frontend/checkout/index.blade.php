                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6 address_select_custom">
                                <div class="custom_select">
                                    ...
                                    <select class="form-control select-active col-12" name="shipping_id" id="shipping_id"
                                        required>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6">
                            <label for="address" class="fw-bold text-black col-form-label"><span
                                    class="text-danger">*</span>Address:</label>
                            <textarea class="form-control addressForNew" name="address" id="address" required placeholder="Address"></textarea>
                            @error('address')
                                <span>{{ $message }}</span>
                            @enderror
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#addressStore').on('click', function() {
                ...
                var address = $('.addressForNew').val();
                console.log("address mia", address);
