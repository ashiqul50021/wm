                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                           ...
                           <!--  <div class="product-detail-rating">
                            ...
                            <form id="choice_form">
                                <div class="row mb-3 gy-2" id="attributes">
                            ...
                            <div class="font-xs">
                                <ul>
                                    ...
                                    <li class="mb-5">Stock:
                                        <span class="badge badge-pill badge-success" id="pavailable" style="background: black; color: white;">Available</span>
                            ...
                            <div class="detail-extralink d-flex mb-30" style="margin-top: 10px;">
                                ...
                                <div class="product-extra-link2">
                                    ...
                                    <div class="d-flex flex-wrap w-100">
                                        ...
                                        <button  class="button button-add-to-cart bg-dark ml-5" onclick="buyNow()" id="closeModel"><i class="fi-rs-shopping-cart"></i>Buy Now</button>
                                    </div>
