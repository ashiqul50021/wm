...
@section('admin')
 <section class="content-main">
    <div class="content-header">
        ...
        in_array('1001', json_decode(Auth::guard('admin')->user()->staff->role->permissions)))
        <div>
        ...
        <div class="col-lg-3">
            <div class="card card-body mb-4">
                <article class="icontext">
                    ...
                    <div class="text">
                        <h6 class="mb-1 card-title">Price Value of Products</h6>
                        <span>৳ {{ number_format($priceValueOfProducts, 2) ?? 'N/A' }}</span>
        ...
        <div class="col-lg-3">
            <div class="card card-body mb-4">
                <article class="icontext">
                    ...
                    <div class="text">
                        <h6 class="mb-1 card-title">Branch</h6>
